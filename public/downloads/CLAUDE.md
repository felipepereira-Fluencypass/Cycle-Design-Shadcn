...
|------------|--------|---------|-------------|
| Button | Instalado | `button.tsx` | 6 variants (default, destructive, outline, secondary, ghost, link), 8 sizes (default, xs, sm, lg, icon, icon-xs, icon-sm, icon-lg). Suporta `.theme-*` para variações de cor. |

> **Próximo a instalar**: Input
